	...
	dinoData: [
		{
			...
			"latLongs": ["Granby, Colorado", "Garden Park, Colorado", "Emery County, Utah", "Shell, Wyoming"],
			"food": "carnivore",
			...
			"name": "Ankylosaurus",
			"continents": ["North America"],
			"latLongs": ["Hell Creek, Montana", "Lance Creek, Wyoming", "Elnora, Alberta, Canada"],
			"food": "herbivore",
			...
			"name": "Coelophysis",
			"continents": ["North America"],
			"latLongs": ["Farmington, New Mexico", "Ghost Ranch, New Mexico"],
			"food": "carnivore",
			...
			"name": "Deinonychus",
			"continents": ["North America"],
			"latLongs": ["Shell, Wyoming", "Ardmore, Oklahoma", "Delaware", "Maryland", "New Jersey"],
			"food": "carnivore",
			...
			"name": "Diplodocus",
			"continents": ["North America"],
			"latLongs": ["Cañon City, Colorado", "Utah", "Montana", "Sheridan, Wyoming"],
			"food": "herbivore",
			...
			"latLongs": ["Morrison, Colorado", "Como Bluff, Wyoming", "Cañon City, Colorado", "Portugal"],
			"food": "herbivore",
			...
			"name": "Triceratops",
			"continents": ["North America"],
			"latLongs": ["Denver, Colorado", "Lance Creek, Wyoming", "South Dakota", "Saskatchewan, Canada", "Alberta, Canada"],
			"food": "herbivore",
			"description": ""
		},
			{
			...
			"continents": ["North America"],
			"latLongs": ["Golden, Colorado", "Douglas, Wyoming", "Jordan, Montana"],
			"food": "carnivore",
			...
			"continents": ["South America"],
			"latLongs": ["Río Negro Province, Argentina", "Neuquén Province, Argentina"],
			"food": "herbivore",
			...
			"name": "Austroraptor",
			"continents": ["South America"],
			"latLongs": ["Bajo de Santa Rosa, Argentina"],
			"food": "carnivore",
			...
			"name": "Carnotaurus",
			"continents": ["South America"],
			"latLongs": ["Bajada Moreno, Argentina"],
			"food": "carnivore",
			...
			"name": "Eoraptor",
			"continents": ["South America"],
			"latLongs": ["Valle de la Luna, Argentina"],
			"food": "omnivore",
			"description": ""
		},
				{
			...
			"name": "Archaeopteryx",
			"continents": ["Europe"],
			"latLongs": ["Solnhofen, Germany", "Eichstätt, Germany"],
			"food": "carnivore",
			...
			"name": "Balaur",
			"continents": ["Europe"],
			"latLongs": ["Sebeș, Alba County, Romania"],
			"food": "carnivore",
			...
			"name": "Cetiosaurus",
			"continents": ["Europe"],
			"latLongs": ["Bletchingdon, United Kingdom", "Le Portel, France"],
			"food": "herbivore",
			...
			"name": "Compsognathus",
			"continents": ["Europe"],
			"latLongs": [" Riedenburg-Kelheim, Germany", "Canjuers, France", "Morocco"],
			"food": "carnivore",
			...
			"name": "Plateosaurus",
			"continents": ["Europe"],
			"latLongs": ["Nuremberg, Germany", "Halberstadt, Germany"],
			"food": "herbivore",
			...
			"latLongs": ["Kayenta, Arizona", "Yunnan Province, China"],
			"food": "carnivore",
			...
			"name": "Microraptor",
			"continents": ["Asia"],
			"latLongs": ["Liaoning Province, China"],
			"food": "carnivore",
		...
		},				
		{
			"name": "Psittacosaurus",
			"continents": ["Asia"],
			"latLongs": ["China", "Mongolia", "Russia", "Thailand"],
			"food": "herbivore",
			...
			"continents": ["Asia"],
			"latLongs": ["Shandong Province, China"],
			"food": "herbivore",
			...
			"name": "Velociraptor",
			"continents": ["Asia"],
			"latLongs": ["Mongolia", "Inner Mongolia"],
			"food": "carnivore",
			...
			"name": "Spinosaurus",
			"continents": ["Africa"],
			"latLongs": ["Giza, Egypt", "Kem Kem, Morocco"],
			"food": "carnivore",
			...
			"continents": ["Africa"],
			"latLongs": ["Algeria", "Morocco", "Niger", "Egypt"],
			"food": "carnivore",
			...
			"name": "Eocursor",
			"continents": ["Africa"],
			"latLongs": ["Free State, South Africa"],
			"food": "carnivore",
			...
			"name": "Massospondylus",
			"continents": ["Africa"],
			"latLongs": ["Harrismith, Free State, South Africa", "Lesotho", "Mashonaland West, Zimbabwe"],
			"food": "herbivore",
			...
			"latLongs": ["Beardmore Glacier Antarctica"],
			"food": "carnivore",
			...
			"latLongs": ["Roma, Queensland", "Fort McMurray, Canada"],
			"food": "herbivore",
			...
			"continents": ["Australia"],
			"latLongs": ["Kronosaurus Korner, Queensland"],
			"food": "herbivore",
			...
			"name": "Antarctopelta",
			"continents": ["Antarctica"],
			"latLongs": ["James Ross Island, Antarctica"],
			"food": "herbivore",
			...
			"continents": ["Australia"],
			"latLongs": ["Opal Creek, Andamooka, Australia"],
			"food": "herbivore",
			...
			"name": "Leaellynasaura",
			"continents": ["Australia"],
			"latLongs": ["Dinosaur Cove, Victoria"],
			"food": "herbivore",
			...
			"name": "Ozraptor",
			"continents": ["Australia"],
			"latLongs": ["Geraldton, Western Australia, Australia"],
			"food": "carnivore",
